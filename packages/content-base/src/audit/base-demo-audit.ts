...
export const baseDemoAudit: ContentAuditCatalog = {
  packId: 'base:demo',
  sourceCatalog: [{ sourceId: 'official-base-site', kind: 'official-rulebook', title: '冒險少女公會 官方規則與 FAQ', url: 'https://www.paintcanfarm.com/aggboardgames/zh', locator: '基礎版規則書與 FAQ 入口；逐張卡片定位待人工覆核', accessedOn: '2026-07-26', availability: 'candidate-only' }],
