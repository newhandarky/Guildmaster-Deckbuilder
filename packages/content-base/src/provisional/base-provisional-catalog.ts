...
const adventurerRows: readonly [string, string, number, number, number, string?][] = [
  ['adventurer-01','麥娜',4,2,2,'討伐階段結束後，若本回合擊敗目標，可從棄牌堆取回 1 張冒險者至手牌。'], ['adventurer-02','托妮卡',3,3,2,'不可配戴裝備。'], ['adventurer-03','卡儂',4,3,1,'討伐開始擲骰；單數時此冒險者戰力 +1。'], ['adventurer-04','修爾蒂',4,2,2,'隊伍第一位冒險者戰力 +2；自身不適用。'], ['adventurer-05','哈貝妮',3,1,1,'購買階段所有裝備費用 -1。'],
...
const resourceRows: readonly [string, string, 'item' | 'equipment', number, number | undefined, number, string][] = [
  ...
  ['resource-06','貓咪娃娃','item',1,undefined,-1,'沒有主動使用效果；購買後將這張牌置入右手邊玩家棄牌堆，且該卡被棄置時改置入目前持有者右手邊玩家棄牌堆。'], ['resource-07','透視眼鏡','equipment',3,1,2,'若由遠程職業配戴，額外增加戰力 1。'], ['resource-08','櫻花果子','item',4,undefined,1,'抽 2 張牌。'], ['resource-09','詛咒之槍','equipment',5,3,3,'若討伐的是魔王，戰力 +2。'], ['resource-10','大號梳毛梳','item',3,undefined,1,'棄 1 張手牌後，抽 2 張。'],
  ['resource-11','寫滿的行程表','equipment',6,2,2,'其他隊友戰力 +1。'], ['resource-12','真龍斧連枷','equipment',5,3,2,'裝備者因戰鬥棄牌時，移除此裝備。'], ['resource-13','賢者之石','item',3,undefined,1,'從棄牌堆取回 1 張「賢者之石」以外的道具卡至手牌。'], ['resource-14','絲綢緞帶','equipment',3,2,2,'限特定職業配戴；配戴者加戰力，且其因戰鬥棄牌時移除此裝備。'], ['resource-15','魔法除塵撢','item',4,undefined,1,'從手牌、隊伍或棄牌堆移除 1 張牌。'],
  ...
  ['resource-21','精緻的耳環','equipment',4,1,1,'購買階段，本回合若擊敗目標獲得購買力。'], ['resource-22','調教手銬','item',3,undefined,1,'選擇場上 1 張魔物為目標；目標回合結束前戰力 −1。'], ['resource-23','元素卷軸','item',4,undefined,2,'隊伍及手牌全部棄至棄牌堆後抽 5；每回合限一次。'], ['resource-24','聖龍護符','equipment',4,1,1,'裝備者因戰鬥棄至棄牌堆時抽 2。'], ['resource-25','騎士之盾','equipment',5,1,2,'限坦克配戴；額外增加戰力 1。'],
