...
export const customAdventurerPresentationPack: PresentationPack = {
  ...
  entries: ([
    ...
    { definitionId: "custom:adventurer/mage-06", displayName: "めぐみん", portraitAssetKey: "custom:portrait/adventurer-mage-06", portraitAltText: "めぐみん的自定義冒險者圖片", shortDisplayText: "討伐階段可指定 1 個魔物或魔王，使其戰力減半（向上取整）直到被討伐；然後將めぐみん移出遊戲。", detailDisplayText: "討伐階段可獨立發動此效果，指定任務區中 1 個公開可用的魔物或魔王，只將該目標目前的戰力除以 2（向上取整）。減半持續到該目標被討伐並離場，不會改變購買力、榮譽、獎勵或其他數值；效果結算後將めぐみん移出遊戲，其附件置入棄牌堆。發動效果不會自動討伐。" },
