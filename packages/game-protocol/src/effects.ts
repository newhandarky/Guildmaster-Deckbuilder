...
export type EffectNode =
  ...
  | { kind: 'choose-card'; choiceId: string; decisionKind?: import('./state.js').PlayerDecisionKind; actor: EffectPlayerRef; from: EffectSelectableCardSource; predicate?: EffectCardPredicate; selectedCardKey: string; selectedLocationKey?: string; effect: EffectNode }
