...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `base:starter/adventurer-01` | `combat` | `1` | 官方規則書／版本資訊 | 印刷頁 3；指定卡片區域 | `<owner>` | `<reviewer>` | `YYYY-MM-DD` | `needs-human-confirmation` | `待獨立來源或正式 audit` |
...
3. 在 `docs/09-待確認事項.md` 新增或連結 open question；需要時請內容負責人提供更清晰、合法且可定位的文字來源。
...
起始候選的實際預填審核列見 [起始內容人工審核包](./19-起始牌審核包.md)。
