...
Supply rows use Rules Module JSON-only configurations and a shared deterministic refill evaluator for setup and rest; no official composition or depletion ruling is inferred.
