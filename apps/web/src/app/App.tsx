...
export function App() {
  ...
  return <main ref={appRootRef} className="app-shell" data-testid="game-app" tabIndex={-1}>
    ...
    <CardDetailsPanel
      ...
      getFocusFallback={() => interactionFallbackRef.current ?? appRootRef.current ?? undefined}
