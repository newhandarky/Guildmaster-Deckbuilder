...
export function App() {
  ...
  return <main className="app-shell">
    ...
    <BoardPanel zones={view.sharedZones} targets={view.enemyTargets} definitions={ruleset.registry.definitions} cards={view.cards} attackableTargetIds={attackableTargetIds} buyableCardIds={buyableCardIds} onAttack={(targetId) => submitAndClear({ type: 'ATTACK_TARGET', targetId })} onBuy={(cardId) => submitAndClear({ type: 'BUY_CARD', cardId })} />
