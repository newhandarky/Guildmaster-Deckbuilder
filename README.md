...
- 卡牌 UI accessibility／usability baseline 包含 WCAG A/AA 自動稽核、skip link、全域 focus-visible、44px 操作目標、320px reflow、放大文字、reduced motion、forced colors 與重新開局二次確認。
